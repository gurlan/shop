            ...
            <div class="xs">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="horizontal-form">
                        <form class="form-horizontal" method="post" action="{{route('admin.news.doAdd')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control1" id="focusedinput" name="title" value="{{old('title')}}">
                                </div>
                                <div class="col-sm-2">
                                    <p class="help-block">{{$errors->first('tite')}}</p>
                                </div>
                            </div>
